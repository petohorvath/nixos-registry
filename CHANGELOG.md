...
Target nixos-project-policy v0.1.1 locally while adoption remains pending. Hosted policy readiness and activation are separate changes; this migration does not publish a library release.
